...
def export_to_csv(list):
    df = pd.DataFrame(list,columns=["File","R1_Precision","R1_Recall","R1_Fmeasure","R2_Precision","R2_Recall","R2_Fmeasure","RL_Precision","RL_Recall","RL_Fmeasure"])
...
for goldensource in goldensources:
    ...
    for prediction in predictions:
        ...
        csv_output.append([prediction,rouge1.precision,rouge1.recall,rouge1.fmeasure,rouge2.precision,rouge2.recall,rouge2.fmeasure,rougeL.precision,rougeL.recall,rougeL.fmeasure])
